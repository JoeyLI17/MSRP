...
class PriceExtractorTests(unittest.TestCase):
    def test_bmw_extract_prices(self):
        ...
        text = "建议零售价 ¥299,900元 起，另有 RMB 35.5万 版本。"
        self.assertEqual(bmw.extract_prices(text), ["¥299,900元", "RMB 35.5万"])

    def test_benz_extract_prices(self):
        benz = load_module("skills/Benz/fetch_price_dynamic.py", "benz_skill")
        text = "官方指导价 ￥459,900元，入门版 RMB 38万。"
        self.assertEqual(benz.extract_prices(text), ["￥459,900元", "RMB 38万"])
